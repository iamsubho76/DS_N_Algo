...
class FindAllNumbersDisappearedInAnArrayTest {
  ...
  private final C25_FindAllNumbersDisappearedInAnArray findAllNumbersDisappearedInAnArray;

  FindAllNumbersDisappearedInAnArrayTest() {
    findAllNumbersDisappearedInAnArray = new C25_FindAllNumbersDisappearedInAnArray();
  }
